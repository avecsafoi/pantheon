 ...
 * @since 2016-01-23
 */
public interface HBaseMapper<T> extends Mapper<T> {
    ...
    default int deleteById(Object obj, boolean useFill) {
        Class<?> entityClass = GenericTypeUtils.resolveTypeArguments(getClass(), HBaseMapper.class)[0];
     ...
     * @since 3.5.3.2
     */
    List<T> selectList(HPage<T> page, @Param(Constants.WRAPPER) Wrapper<T> queryWrapper);
     ...
     * @since 3.5.4
     */
    void selectList(HPage<T> page, @Param(Constants.WRAPPER) Wrapper<T> queryWrapper, ResultHandler<T> resultHandler);
     ...
     * @since 3.5.3.2
     */
    List<Map<String, Object>> selectMaps(HPage<? extends Map<String, Object>> page, @Param(Constants.WRAPPER) Wrapper<T> queryWrapper);
     ...
     * @since 3.5.4
     */
    void selectMaps(HPage<? extends Map<String, Object>> page, @Param(Constants.WRAPPER) Wrapper<T> queryWrapper, ResultHandler<Map<String, Object>> resultHandler);
     ...
     * @param queryWrapper 实体对象封装操作类（可以为 null）
     */
    default <P extends HPage<T>> P selectPage(P page, @Param(Constants.WRAPPER) Wrapper<T> queryWrapper) {
     ...
     * @param queryWrapper 实体对象封装操作类
     */
    default <P extends HPage<Map<String, Object>>> P selectMapsPage(P page, @Param(Constants.WRAPPER) Wrapper<T> queryWrapper) {
